...
if [[ $(tput colors) -ge 256 ]]; then
	...
	elif [[ -n ${BUBBLEENV} ]]; then
		_c="\[\e[0;35m\]"
		if [[ ${BUBBLEENV} == "admin" ]]; then
			_c="\[\e[0;31m\]"
		fi
		PS1="\[\e[0;37m\]\342\224\214\342\224\200\$([[ \$? != 0 ]] && echo \"[\[\e[0;31m\]\342\234\227\[\e[0;37m\]]\342\224\200\")[${_c}${BUBBLEENV}\[\e[0;37m\]]\342\224\200[\[\e[0;32m\]\w\[\e[0;37m\]]\n\[\e[0;37m\]\342\224\224\342\224\200\342\224\200\342\225\274 \[\e[0m\]"
	elif [[ ${EUID} == 0 ]]; then
